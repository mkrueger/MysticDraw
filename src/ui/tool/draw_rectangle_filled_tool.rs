...
{
    unsafe {
        RECT_FILLED_TOOL.char_code = char_code;
    }
}
pub fn add_rectangle_filled_tool_page(main_window: std::rc::Rc<MainWindow>, content_box: &mut gtk4::Box)
{
    unsafe {
        ...
        let button = Rc::new(RefCell::new(crate::ui::create_char_button(main_window.clone(), RECT_FILLED_TOOL.char_code, Box::new(&set_char))));
